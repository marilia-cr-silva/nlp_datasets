...
df_test = pd.DataFrame(
    [dataset['test']['text'], dataset['test']['sentiment']]).T
df_train = pd.DataFrame(
    [dataset['train']['text'], dataset['train']['sentiment']]).T
...
# %%
df_train.to_csv("pc_02_bin_train_0_1.csv", sep=";", index=False)
df_test.to_csv("pc_02_bin_test_0_1.csv", sep=";", index=False)
...
explained_df.to_csv('pc_02_explained.csv', sep=";", index=False)
