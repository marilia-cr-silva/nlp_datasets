...
df_test_aux = pd.DataFrame(
    [dataset['test_fixed']['DOCUMENT'], dataset['test_fixed']['TRUE_SENTIMENT']]).T
df_validation_aux = pd.DataFrame(
    [dataset['validation']['DOCUMENT'], dataset['validation']['TRUE_SENTIMENT']]).T
df_test = pd.concat([df_validation_aux, df_test_aux])
df_test.columns = ['text', 'label']
df_train = pd.DataFrame([dataset['train']['DOCUMENT'],
                        dataset['train']['TRUE_SENTIMENT']]).T
