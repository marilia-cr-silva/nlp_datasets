...
df_content = pd.read_csv("sa_20.csv")
...
df_train.to_csv("ua_20_multi_train.csv", sep=";", index=False)
df_test.to_csv("ua_20_multi_test.csv", sep=";", index=False)
...
for i in tqdm(range(len(unique_classes))):
    for j in range(i + 1, len(unique_classes)):
        ...
        df_aux.to_csv(f"ua_20_bin_train_{i}_{j}.csv", sep=";", index=False)
        ...
        df_aux.to_csv(f"ua_20_bin_test_{i}_{j}.csv", sep=";", index=False)
...
explained_df.to_csv("ua_20_explained.csv", sep=";", index=False)
