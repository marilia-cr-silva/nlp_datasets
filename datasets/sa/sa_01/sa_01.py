...
# %%
df_train.to_csv('sa_01_bin_train_0_1.csv', sep=';', index=False)
df_test.to_csv('sa_01_bin_test_0_1.csv', sep=';', index=False)
...
explained_df.to_csv('sa_01_explained.csv', sep=";", index=False)
