...
# %% creating DataFrames
df_train = pd.read_csv("sa_07_train.csv", sep=',', header=None, names=['label', 'text'])
df_test = pd.read_csv("sa_07_test.csv", sep=',', header=None, names=['label', 'text'])             
...
# %%
df_train.to_csv('sa_07_bin_train_0_1.csv', sep=';', index=False)
df_test.to_csv('sa_07_bin_test_0_1.csv', sep=';', index=False)
...
explained_df.to_csv('sa_07_explained.csv', sep = ";", index=False)