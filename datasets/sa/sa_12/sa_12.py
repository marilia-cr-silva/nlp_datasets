...
# %% creating dataframe
os.chdir('/mnt/c/Users/Acer/Documents/Corpora/downloaded/SA12_Amazon')

# %% train
df_train = pd.read_csv('Musical_instruments_reviews.csv')
df_train = df_train[['reviewText','overall']]
...
df_train.to_csv('SA12_Multi_train.csv',sep=';',index=False)
...
for i in tqdm(range(len(unique_classes))):
    for j in range(i+1,len(unique_classes)):
        # train
        csv_file_name_train = f'SA12_Binary_{i}_{j}_train.csv'
