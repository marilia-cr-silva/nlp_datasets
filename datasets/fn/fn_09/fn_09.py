...
df_test_aux = pd.read_csv('fn_09_test.csv',sep=';')
df_validation_aux = pd.read_csv('fn_09_dev.csv',sep=';')
df_test = pd.concat([df_validation_aux,df_test_aux])
df_train = pd.read_csv('fn_09_train.csv',sep=';')
...
explained_df.to_csv('fn_09_explained.csv', sep = ";", index=False)