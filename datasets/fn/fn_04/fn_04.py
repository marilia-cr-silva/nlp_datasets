...
df_content = pd.read_csv(
    ...
    sep=',',
    lineterminator='\n',
    usecols=['fact_rating_phase1', 'snopes_url_phase1', 'article_title_phase1', 'article_category_phase1', 'article_date_phase1', 'article_claim_phase1', 'article_origin_url_phase1',
             'index_paragraph_phase1', 'page_is_first_citation_phase1', 'error_phase2', 'original_article_text_phase2', 'article_title_phase2', 'publish_date_phase2', 'author_phase2']
)
...
df_train.to_csv("fn_04_multi_train.csv", sep=";", index=False)
df_test.to_csv("fn_04_multi_test.csv", sep=";", index=False)
...
explained_df.to_csv('fn_04_explained.csv', sep=";", index=False)
