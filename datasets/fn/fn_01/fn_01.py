...
os.chdir("/mnt/c/Users/Acer/Documents/corpora_new/multiclass/fake_news_detection_and_fact_checking")
...
os.chdir("/mnt/c/Users/Acer/Documents/corpora_new/binary/fake_news_detection_and_fact_checking")
...
for i in tqdm(range(len(unique_classes))):
    for j in range(i+1,len(unique_classes)):
        ...
        df_aux.to_csv(f"fn_01_bin_test__{i}_{j}.csv",sep=";",index=False)
        list_csv.append([f"fn_01_bin_test__{i}_{j}.csv",f"{unique_classes[i],unique_classes[j]}"])
