...
# %% changing directory
os.chdir('/mnt/c/Users/Marília/Documents/Corpora/downloaded/HS12_Terrorism')

# %% loading dataset and creating dataframe
df_test = pd.read_csv('HS12_test.csv')
...
# %% loading dataset and creating dataframe
df_train = pd.read_csv('HS12_train.csv')
...
df_train.to_csv(f'HS12_Binary_train.csv',sep=';',index=False)
df_test.to_csv(f'HS12_Binary_test.csv',sep=';',index=False)