...
# %% creating dataframe
df = pd.DataFrame([dataset['train']['text'],dataset['train']['label']]).T
...
# %%
df_train.to_csv('hs_10_bin_train_0_1.csv', sep=';', index=False)
df_test.to_csv('hs_10_bin_test_0_1.csv', sep=';', index=False)
...
explained_df.to_csv('hs_10_explained.csv', sep = ";", index=False)