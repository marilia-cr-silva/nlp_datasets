...
df_train = pd.read_csv('HS1.csv',sep=';')
...
df_train = df_train[df_train['label'] != 'racism']
df_train = df_train[['text','label','id']]
df_train.to_csv('HS1_unpreproc_with_ids.csv',sep=';',index=False)
...
df_train.to_csv(f'HS01_Binary_train.csv',sep=';',index=False)