'''
@misc{kaggle_dinamically_generated,
  author       = "Kaggle",
  title        = "Dynamically Generated Hate Speech Dataset",
  howpublished = "\url{https://www.kaggle.com/datasets/usharengaraju/dynamically-generated-hate-speech-dataset?select=2020-12-31-DynamicallyGeneratedHateDataset-entries-v0.1.csv}",
  year         = "2021",
}
'''
...
# %% changing directory
os.chdir('/mnt/c/Users/Marília/Documents/Corpora/downloaded/HS13_Dinamically')

df = pd.read_csv('HS13_Dinamically.csv')
...
df_train.to_csv(f'HS13_Binary_train.csv',sep=';',index=False)
df_test.to_csv(f'HS13_Binary_test.csv',sep=';',index=False)