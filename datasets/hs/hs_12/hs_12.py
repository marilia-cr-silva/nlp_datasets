...
df_test = pd.read_csv('hs_12_test.csv')
...
# %% loading dataset and creating dataframe
df_train = pd.read_csv('hs_12_train.csv')
...
# %%
df_train.to_csv('hs_12_bin_train_0_1.csv', sep=';', index=False)
df_test.to_csv('hs_12_bin_test_0_1.csv', sep=';', index=False)
...
explained_df.to_csv('hs_12_explained.csv', sep = ";", index=False)