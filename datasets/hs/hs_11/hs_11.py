...
# %%
df_train.to_csv('hs_11_bin_train_0_1.csv', sep=';', index=False)
df_test.to_csv('hs_11_bin_test_0_1.csv', sep=';', index=False)
...
explained_df.to_csv('hs_11_explained.csv', sep=";", index=False)
