...
language_identification_model = fasttext.load_model('lid.176.bin')
...
df_test_label = pd.read_csv('hs_04_test_labels.csv')
df_test_text = pd.read_csv('hs_04_test_text.csv')
...
# %% loading dataset and creating dataframe
df_train = pd.read_csv('hs_04_train_text_label.csv')
df_train = df_train[['comment_text', 'toxic']]
...
# %%
df_train.to_csv('hs_04_bin_train_0_1.csv', sep=';', index=False)
df_test.to_csv('hs_04_bin_test_0_1.csv', sep=';', index=False)
...
explained_df.to_csv('hs_04_explained.csv', sep=";", index=False)
